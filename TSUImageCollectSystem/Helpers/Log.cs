...
namespace TSUImageCollectSystem.Helpers
{
	...
	public class Log
	{
		...
		public static void LogThisInfo(string format, params object[] args)
		{
			LogThis(string.Format(format, args), eloglevel.info);
		}

		public static void LogThisError(string format, params object[] args)
		{
			LogThis(string.Format(format, args), eloglevel.error);
		}

		public static void LogThisVerbose(string format, params object[] args)
		{
			LogThis(string.Format(format, args), eloglevel.verbose);
		}

		public static void LogThisWarn(string format, params object[] args)
		{
			LogThis(string.Format(format, args), eloglevel.warn);
		}
		...
		public static void UseSensibleDefaults(string logFileName)
		{
			string[] logFile = DefaultLogFileAndLocation();
			UseSensibleDefaults(logFileName, logFile[0], eloglevel.info);
		}
