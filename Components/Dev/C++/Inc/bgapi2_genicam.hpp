...
namespace BGAPI2
{
    ...
    */
    ...
    private:
        ...
        bo_bool UpdateBgapiObjects(bo_uint64 iTimeout);
        bo_uint64 NumberOfBgapiObjects();
        String GetId(bo_uint64 index);
        Interface* createBgapi2Object(String id);
    ...
    */
    ...
    private:
        ...
        bo_uint64 NumberOfBgapiObjects();
        String GetId(bo_uint64 index);
        Device* createBgapi2Object(String id);
    ...
    */
    ...
    private:
        ...
        bo_uint64 NumberOfBgapiObjects();
        String GetId(bo_uint64 index);
        DataStream* createBgapi2Object(String id);
    ...
    */
    ...
    public:
        ...
        * \return    String The user specific data.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        */
        String GetExtension();
        ...
        * \brief     Valid for the interface types 'IFloat', 'IInteger', 'IEnumeration', IString', 'IBoolean' und 'ICommand'.
        ...
        * \brief     Only valid for the interface type 'IInteger'.
    ...
    */
    namespace Events
    {
        ...
        */
        ...
        public:
            /**
            * \fn        RegisterCustomEvent
            * \brief     This function registers an user specific event.
            * \param     custom_id The ID of an user specific event to register.
            * \exception Exceptions::NotInitializedException The BGAPI object is not open.
            * \exception Exceptions::ObjectInvalidException The calling object is not valid.
            * \exception Exceptions::InvalidParameterException The custom_id must be greather than 1000.
            * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
            */
            void RegisterCustomEvent(bo_uint64 custom_id);

            /**
            * \fn        UnregisterCustomEvent
            * \brief     This function unregisters an user specific event.
            * \param     custom_id The ID of an user specific event that is supposed to be unregister.
            * \exception Exceptions::NotInitializedException The BGAPI object is not open.
            * \exception Exceptions::ObjectInvalidException The calling object is not valid.
            * \exception Exceptions::InvalidParameterException The custom_id must be greater than 1000.
            * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
            */
            void UnregisterCustomEvent(bo_uint64 custom_id);
        ...
        */
        ...
        public:
            ...
            * \param     eventMode The event mode specifies the way as an incoming event is to be fetched.
            * \exception Exceptions::NotInitializedException The BGAPI object is not open.
            * \exception Exceptions::ObjectInvalidException The calling object is not valid.
            ...
            * \param	 void * callBackOwner Any object, stays at it is.
            * \param	 NewBufferEventHandler pFunc Callback event handler.
            * \exception Exceptions::NotInitializedException The BGAPI object is not open.
    ...
    */
    ...
    public:  
        ...
        * \param     Enable or disable the replace mode. Enable or disable the replace mode. This mode will control whether all accesses to a register will be transferred to the device or only the last one. 
    ...
    */
    ...
    public: 
        ...
        * \brief     This constuctor sets the path to the producer file.
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * \fn        TransformImage
        * \brief     This function transformes the pixelformat of this Image object and creates a new Image object.
        * \param     sPixelFormat The destination pixel format of the new Image object.
        * \param     ppOutputImage The destination Image object.
        * \exception Exceptions::ErrorException Error while transform the image.
        */
        void TransformImage( String sPixelFormat, Image** ppOutputImage );
        ...
        * \param     sPixelFormat The destination pixel format.
        * \param     pBuffer The destination buffer.
        * \param     uBufferSize The destination buffer size.
        * \exception Exceptions::ErrorException Error while transform the image.
        */
        void TransformImageToBuffer( String sPixelFormat, void* pBuffer, bo_uint64 uBufferSize );
    ...
    */
    ...
    public:
        /**
        * \fn        GetInstance
        * \brief     This function creates an singleton instance of ImageProcessor.
        * \return    ImageProcessor* The pointer to instance of the ImageProcessor.
        * \see       ImageProcessor::ReleaseInstance
        */
        static ImageProcessor *GetInstance();

        /**
        * \fn        ReleaseInstance
        * \brief	 This function releases the instance of ImageProcessor. 
        * \see		 ImageProcessor::GetInstance
        */
        static void ReleaseInstance();
    ...
    private:
        ...
        ~ImageProcessor();    
        static ImageProcessor* m_pInstance;
